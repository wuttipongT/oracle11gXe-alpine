...
```
docker run -d -P --shm-size=1g -v db_data:/u01/app/oracle/oradata -p 1521:1521 -p 8080:8080 <image name>:<tag>
```
...
```
docker run -d -P --shm-size=1g -v db_data:/u01/app/oracle/oradata -p 1521:1521 -p 8080:8080 bwutti/oracle:11gXe-alpine
```
